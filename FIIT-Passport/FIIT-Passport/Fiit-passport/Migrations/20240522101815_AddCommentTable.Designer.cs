...
namespace Fiit_passport.Migrations
{
    ...
    [Migration("20240522101815_AddCommentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fiit_passport.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("PassportSessionId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Fiit_passport.Models.Comment", b =>
                {
                    b.HasOne("Fiit_passport.Models.Passport", "Passport")
                        .WithMany("Comments")
                        .HasForeignKey("PassportSessionId")
